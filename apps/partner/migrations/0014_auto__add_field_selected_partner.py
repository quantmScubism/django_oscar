...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stockrecord.selected_partner'
        db.add_column('partner_stockrecord', 'selected_partner',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, max_length=128),
                      keep_default=True)

    def backwards(self, orm):
        # Deleting field 'Stockrecord.selected_partner'
        db.delete_column('partner_stockrecord', 'selected_partner')
