...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StockRecord', fields ['partner', 'partner_sku', 'product']
        db.create_unique('partner_stockrecord', ['product_id', 'partner_id', 'partner_sku', 'selected_partner'])



    def backwards(self, orm):
        # Removing unique constraint on 'StockRecord', fields ['partner', 'partner_sku', 'product']
        db.delete_unique('partner_stockrecord', ['product_id', 'partner_id', 'partner_sku', 'selected_partner'])
    ...
    models = {
        ...
        'partner.stockrecord': {
            ...
            'selected_partner': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'default': '0', 'max_length': '128'}),
        }
    }
