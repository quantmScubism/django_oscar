...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.buy_count_all_time'
        db.add_column('catalogue_product', 'buy_count_all_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, max_length=32),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'Product.user_id'
        db.delete_column('catalogue_product', 'buy_count_all_time')
