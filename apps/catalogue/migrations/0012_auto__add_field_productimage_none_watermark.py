...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.none_watermark'
        db.add_column('catalogue_productimage', 'none_watermark', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True, default=''), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ProductImage.none_watermark'
        db.delete_column('catalogue_productimage', 'none_watermark')
    ...
    models = {
        ...
        'catalogue.productimage': {
            ...
            #'none_watermark': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True', 'default': ''})
        },
